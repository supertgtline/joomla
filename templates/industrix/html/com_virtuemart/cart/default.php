...
<div class="cart-view">
	...
	<div class="row css-vm-newuser">
		<div class="col-xs-12 col-sm-9 ">
			<div class="css-newuser-txt">
				<?php echo vmText::_('TPL_VM_NEW_USER'); ?> <a href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&layout=edit'); ?>"><?php echo vmText::_('TPL_VM_NEW_USER_REGISTER'); ?></a>
			</div>
	...
	?><form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
		...
		if(VmConfig::get('multixcart')=='byselection'){
			...
			?><input type="submit" name="updatecart" title="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" class="button""/><?php
		}
