...
<div class="billto-shipto">
	...
	<div class="col-xs-12 col-sm-12 col-md-6">
		...
		<h3><span class="icon icon-home2"></span>
			<?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></h3>
		...
		<a class="btn btn-primary" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
	...
	<div class="col-xs-12 col-sm-12  col-md-6">
		...
		<h3><span class="icon icon-mail2"></span>
			<?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></h3>
		<?php // Output Bill To Address ?>
		...
		<a class="btn btn-primary" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
