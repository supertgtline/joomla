...
<tr valign="top" class="sectiontableentry<?php echo $i ?>">
	...
	<td class="css-cartsummery-name" align="left">
	...
	<td class="css-quantity-update" align="right"><?php
		   ...
		   <input type="text"
			...
			<button type="submit" class="fa fa-refresh vm2-add_quantity_cart" name="updatecart.<?php echo $pkey ?>" title="<?php echo  vmText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>" />

			<button type="submit" class="fa fa fa-times vm2-remove_from_cart" name="delete.<?php echo $pkey ?>" title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" />
	</td>
...
<tr class="css-vm-product-price-total">
...
if (VmConfig::get ('coupons_enable')) {
	?>
<tr class="sectiontableentry2 css-coupon">
	...
	<?php if (!$this->cart->automaticSelectedShipment) { ?>
		...
		if (!empty($this->layoutName) and $this->layoutName == 'default') {
			if (VmConfig::get('oncheckout_opc', 0)) {
				echo '<div class="checkoutStep" id="checkoutStep2">';
				echo '<h3>' . vmText::_('COM_VIRTUEMART_USER_FORM_CART_STEP2') . '</h3>';
				echo '<span>'.vmText::_ ('COM_VIRTUEMART_CART_SELECTED_SHIPMENT').'</span>:';
...
<tr class="sectiontableentry1">
	<?php if (!$this->cart->automaticSelectedPayment) { ?>
		...
		if (!empty($this->layoutName) && $this->layoutName == 'default') {
			if (VmConfig::get('oncheckout_opc', 0)) {
				echo '<div class="checkoutStep" id="checkoutStep3"><h3>' . vmText::_('COM_VIRTUEMART_USER_FORM_CART_STEP3') . '</h3></div>';
				echo '<span>'.vmText::_ ('COM_VIRTUEMART_CART_SELECTED_PAYMENT').'</span>:';
...
<tr class="css-vm-shop-price-final">
	...
	<td align="right"><?php echo $this->currencyDisplay->createPriceDiv ('billTotal', '', $this->cart->cartPrices['billTotal'], FALSE); ?></td>
</tr>
<?php
