...
defined('_JEXEC') or die('Restricted access');
	...
	if (VmConfig::get('oncheckout_show_steps', 1)) {
		//echo '<div class="checkoutStep" id="checkoutStep2"><h3>' . vmText::_('COM_VIRTUEMART_USER_FORM_CART_STEP2') . '</h3></div>';
	}
...
<form method="post" id="userForm" name="chooseShipmentRate" action="<?php echo JRoute::_('index.php'); ?>" class="form-validate">
	<?php
		...
		$headerLevel = 3;
		$buttonclass = 'btn btn-primary css-vm-button-correct';
	}

	if($this->cart->virtuemart_shipmentmethod_id){
		echo "<h4>".vmText::_('COM_VIRTUEMART_CART_SELECTED_SHIPMENT_SELECT')."</h4>";
	} else {
		echo "<span>".vmText::_('COM_VIRTUEMART_CART_SELECT_SHIPMENT')."</span>";
	}
