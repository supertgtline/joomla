...
<div class="orderby-displaynumber">
	...
	<div class="floatright display-number"><span><?php echo $this->vmPagination->getResultsCounter ();?></span>
		<div><?php echo $this->vmPagination->getLimitBox ($this->category->limit_list_step); ?></div></div>


	<div class="clear"></div>
</div> <!-- end of orderby-displaynumber -->

<h1 class="css-vmcategory-title"><?php echo $this->category->category_name; ?></h1>
