...
<div class="productdetails-view productdetails">
	...
	?>
		...
		echo $this->linkIcon($link . '&format=pdf', 'COM_VIRTUEMART_PDF', 'pdf_button', 'pdf_icon', false,true,false,'class="css-pdficon"');
	    ...
	    <div role="tabpanel" class="css-productdetails-tab">
			  ...
			  <ul class="nav nav-tabs" role="tablist">
				...
				if (!empty($this->product->product_desc)) {
					    ?>
			    	<li role="presentation" class="active"><a href="#tab1" aria-controls="description" role="tab" data-toggle="tab"><span class="title"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></span></a></li>
			    <?php }?>

			    <li role="presentation"><a href="#tab2" aria-controls="reviews" role="tab" data-toggle="tab"><?php echo vmText::_ ('COM_VIRTUEMART_REVIEWS') ?></a></li>

			    <li role="presentation">
			    	<a href="#tab3" aria-controls="manufacturer" role="tab" data-toggle="tab">Manufacturer
					</a>
				</li>
			  </ul>
