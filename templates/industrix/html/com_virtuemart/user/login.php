...
<?php   }
	...
	<div class="css-shoplogin-header">
		<h2><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h2>
	</div>
<div class="clear"></div>
<?php } else { ?>
        <h2><i class="fa fa-user"></i><?php echo vmText::_ ('TPL_CUSTOMER_LOGIN'); ?></h2>
        <p><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></p>
<?php }   ?>
    
        <div class="row">
            <div class="col-xs-12 col-sm-4" id="com-form-login-username">
            ...
            <div class="col-xs-12 col-sm-4" id="com-form-login-password">
            ...
            <div class="col-xs-12 col-sm-4" id="com-form-login-remember">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4">
                  <?php if (JPluginHelper::isEnabled('system', 'remember')) : ?>
                    <div class="css-login-remember-checkbox">
