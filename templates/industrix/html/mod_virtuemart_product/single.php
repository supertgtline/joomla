...
$product->virtuemart_category_id); ?>		<h3><a href="<?php echo $url ?>" class="css-vmgroup-productname"><?php echo $product->product_name ?></a> 

<?php
// $product->prices is not set when show_prices in config is unchecked
echo '<span class="css-vmgroup-productprice">';
